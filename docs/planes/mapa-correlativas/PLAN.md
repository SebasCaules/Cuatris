...
Fuera de alcance (anotado, no se hace): portar a StudyVaults (`CAMBIOS-LOCALES.md` §21 lo
...
| U10 | `CAMBIOS-LOCALES.md` §21, `README.md` si nombra el mapa | transversal (orquestador) | baja |
